...
class ClientAuthTest < BaseTest
  def setup
    ...
    super
    @cache = Memcached::Client.new(ENV['TEST_CREDENTIAL_SERVER'], hash: :default, distribution: :modula,
prefix_key: @prefix_key, credentials: [ENV['TEST_USERNAME'], ENV['TEST_PASSWORD']])
  end
